...
These files preserve the upstream content as a local reference for validator
behavior and conformance tests; line endings follow this repository's checkout
convention. Update them only as an explicit OGraf specification upgrade.
